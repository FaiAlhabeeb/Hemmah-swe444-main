  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      bottomNavigationBar: GNav(
        ...
        GButton(icon: Icons.add_box_outlined, iconColor: Color.fromARGB(255, 135, 108, 139),onPressed: (){Navigator.push(context,MaterialPageRoute(builder: (context) => PostJobScreen()));},), 
